...
public class CompteCheque extends com.atoudeft.banque.CompteBancaire {
    ...
    {
        this.historique.add(new OperationRetrait(montant,TypeOperation.RETRAIT));
        return false;
    }
    ...
    {
        this.historique.add(new OperationFacture(montant,TypeOperation.FACTURE,numeroFacture,description));
        return false;
    }
